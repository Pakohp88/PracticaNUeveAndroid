...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.searchText.setOnClickListener{
            ...
            url="https://google.es/search?q"+URLEncoder.encode(
    ...
    private fun buscar(){
        var stringRequest = object: StringRequest(
            ...
            Response.Listener<String>{
                response -> binding.outText.text = response
            },
            Response.ErrorListener { binding.outText.text = "No se encuetra la información" }){
    ...
    private fun studentsAdd(){
        ...
        val jsonRequest = object : JsonArrayRequest( urlJSON,
            ...
            override fun getMethod(): Int { return Method.POST
            }
        }
        volleyAPI.add(jsonRequest)
    }
